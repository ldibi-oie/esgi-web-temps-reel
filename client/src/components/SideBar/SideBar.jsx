...
export default function SideBar() {
  return (
    <>
                <div id="menu" class="bg-gray-900 min-h-screen z-10 text-slate-300 w-80 left-0 h-screen ">
                ...
                <div id="nav" class="w-full px-6">
                    ...
                    <a href="#" class="w-full px-2 inline-flex space-x-2 items-center border-b border-slate-700 py-3 hover:bg-white/5 transition ease-linear duration-150">
                        ...
                        <div class="flex flex-col">
                            <span class="text-lg font-bold leading-5">Database</span>
                    ...
                    <a href="#" class="w-full px-2 inline-flex space-x-2 items-center border-b border-slate-700 py-3 hover:bg-white/5 transition ease-linear duration-150">
                        ...
                        <div class="flex flex-col">
                            <span class="text-lg font-bold leading-5">Cloud Storage</span>
                    ...
                    <a href="#" class="w-full px-2 inline-flex space-x-2 items-center border-b border-slate-700 py-3 hover:bg-white/5 transition ease-linear duration-150">
                        ...
                        <div class="flex flex-col">
                            <span class="text-lg font-bold leading-5">Reports</span>
                    ...
                    <a href="#" class="w-full px-2 inline-flex space-x-2 items-center border-b border-slate-700 py-3 hover:bg-white/5 transition ease-linear duration-150">
                        ...
                        <div class="flex flex-col">
                            <span class="text-lg font-bold leading-5">Security</span>
                    ...
                    <a href="#" class="w-full px-2 inline-flex space-x-2 items-center border-b border-slate-700 py-3 hover:bg-white/5 transition ease-linear duration-150">
                        ...
                        <div class="flex flex-col">
                            <span class="text-lg font-bold leading-5">Extensions</span>
                    ...
                    <a href="#" class="w-full px-2 inline-flex space-x-2 items-center py-3 hover:bg-white/5 transition ease-linear duration-150">
                        ...
                        <div class="flex flex-col">
                            <span class="text-lg font-bold leading-5">Settings</span>
